...
public class ShapeLoadingView extends View {
    ...
    private void init() {
        mCircleColor = getResources().getColor(R.color.color_theme_dark_blue);
        mRectColor = getResources().getColor(R.color.color_theme_normal_blue);
        mTriangleColor = getResources().getColor(R.color.color_theme_light_blue);
