 ...
 * </pre>
 */
public class LshTextPreference extends TextPreference {

    public LshTextPreference(Context context) {
        super(context);
    }

    public LshTextPreference(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
